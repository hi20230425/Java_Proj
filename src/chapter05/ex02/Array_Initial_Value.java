...
public class Array_Initial_Value {
	public static void main(String[] args) {
		...
		int val1 ; 		// 변수 선언 
		//System.out.println(val1);     //오류 발생 , 변수에 기본 값을 할당 하지 않아서 오류 발생  
		...
		int[] val3 = null;      // 참조 자료형일때만 객체 주소에 null 할당 할 수 가 있음 
		System.out.println(val3);   // 객체 자체를 출력할때 Stack에 저장된 Heap 의 주소 : 16진수 
		val3 = new int[4]; 
		...
		// Arrays.toString(배열변수) ;      //배열의 모든값을 출력 
