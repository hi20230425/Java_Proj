	...
	public static void main(String[] args) {
		/*
		    Object 클래스의 equals() 메소드 :  기본적으로 == Stack의 주소를 비교 하도록 설정 
		    	equals() 메소드는 Heap의 값을 비교 하는 것이 아니라 Stack 메모리의 참조 주소를 비교 하도록 셋팅 
		    	// 그래서 equals() 메소드를 Heap의 값을 비교 할 수 있도록 재정의 해서 사용해야 함. 
		...
		System.out.println(b1 == b2);      //false     // stack의 주소 를 비교 
		System.out.println(b1.equals(b2));  //true     // Heap 의 값을 비교 
