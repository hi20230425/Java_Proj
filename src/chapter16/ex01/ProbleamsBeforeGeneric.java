...
// 상품을 저장하는 클래스 : Object 와 Generic 를 사용하지 않는 경우 , 하나의 상품 클래스에 하나의 타입의 상품을 저장함. 
	...
	public static void main(String[] args) {
		/*
		     제너릭을 사용하기전의 여러 가지 문제점 : 
		         ...
		         - 제너릭을 사용전에는 하나의 클래스에 다양한 타입의 정보를 저장할려면 각 각의 클래스를 만들어서 사용함. 
		         - 하나의 클래스에 다양한 객체정보를 저장하기 위해서 Object 타입으로 업캐스팅해서 저장후 다시 다운 캐스팅을 사용해서 객체 내부의 
		         	정보를 읽고/쓰기 를 했음. 	         	
		         - 제너릭을 사용하면 업캐스팅 / 다운 캐스팅 없이 여러 타입의 객체를 하나의 클래스에 넣고 사용
