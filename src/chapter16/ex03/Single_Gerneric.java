	...
	public static void main(String[] args) {
		/*
		 	제너릭 클래스 : 다양한 타입을 저장 할 수 있는 클래스 
		 	   - 클래스 이름뒤에 :   <T>      <== 인풋되는 타입을 지정함.  T : Tyte
		 	   - 객체를 생성할때 <T> 에 들어있는 타입을 지정해서 객체를 생성 하게 됨. 
		 	   - <T> 에 들어오는 타입은 반드시 객체형 자료형이이야 한다. 기본 자료형은 올수 없다. , wrapper class를 사용함. 
		...
		//Getter를 사용해서 Banana 객체를 가져와서 필드의 내용을 출력   // 다운캐스팅업시 필드의 내용을 출력 
