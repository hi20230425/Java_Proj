...
class GenericMethod {    //일반 클래스 
	...
	public <T> boolean method2 (T t1 , T t2) {
		...
		return t1.equals(t2);    // 스택의 값을 비교 , String은 equals() 메소드가 Heap의 값을 비교하도록 재정의 되어있다. 
	}
	...
	public static void main(String[] args) {
		/*
		 	제너릭 메소드 : 
		 		...
		 		- 2. 제너릭 메소드의 인풋값이 타입을 유추 할 수 있는 경우 : 메소드 호출시 타입을 생략 가능 하다. 
		 */
		...
		Integer i2 = gm. method(20); 			//제너릭 메소드 호출시 타입을 생략 해서 호출 
