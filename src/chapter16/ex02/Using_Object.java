...
class Goods2 {
	...
	//setter : 필드의 값을 할당 
	public void setObj (Object obj) {     // obj 변수에 자바의 모든 클래스(여러 타입)를 담을수 있다. 
		this.obj = obj; 
	}
	...
	public static void main(String[] args) {
		/*
		 	Object 모든 클래스의 부모 이다. 
		 	  ...
		 	  - 문제가 발생됨 : Object 업캐스팅 되어서 들어간 하위 타입을 알아내기가 어렵니다. 
