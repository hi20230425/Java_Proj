...
class A {   // 일반 클래스 : 제너릭 메소드 생성 
	...
	//매개변수 타입으로 들어오는 변수에서 Object 의 메소드만 사용 가능 하다.  
	public <T> void method ( T t) {
		
		//t.length();      // length() : String 타입에 존재하는 메소드 
		
		
		System.out.println(t.equals("안녕" ));    //Object 의 메소드이므로 모든 타입에서 사용 가능 
...
public class AbableGenericMethod {
	...
	public static void main(String[] args) {
		/*
		 	제너릭 매소드에서 인풋 매개변수에서 사용 가능한 메소드 : Object 클래스의 메소드만 사용 가능 하다.
