...
public class Set_TreeSet_Class {
	public static void main(String[] args) {
		/*
		 	TreeSet <E> : 1. Set<E> 을 인터페이스를 구현한 클래스 , 2. 중복된 값을 넎을수 없다, 3. 방번호가 없다. 
		...
		//   - Comparable<E> 인터페이스를 구현해서 compareTo() 메소드를 오버라이딩해서 특정컬럼이 정렬
...
//		mySet.add(new MyClass(1,1));  mySet.add(new MyClass(5,5)); mySet.add(new MyClass(3,3));
		...
		//2. MyClass2 객체를 TreeSet에 저장 <== Comparable 인터페이스의 comparTo() 메소드를 재정의 함: data1 : dat1 필드를 정렬
