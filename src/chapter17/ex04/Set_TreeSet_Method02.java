...
public class Set_TreeSet_Method02 {
	...
	public static void main(String[] args) {
		/*
		 	TreeSet은 Set<E>, SortedSet<E> (정렬) , NavigableSet<E> (검색) 인터 페이스 을 구현한 클래스 
		...
		System.out.println("==================================");
		//10. NavigableSet<E> headSet(E element) : element 값의 Head 쪽으로 정렬해서 값을 저장 <element는 포함. > 
		for ( int i = 50 ; i > 0 ; i-=2) {
			treeSet.add(i) ; 
		}
		System.out.println(treeSet);
		...
		//* Head 쪽으로 갈때는 미포함, Tail 쪽으로 갈 깨는 포함.    <=== 
		
		
		//11. SortedSet<E> tialSet(E element) : element 값의 Tail 쪽으로 정렬해서 값을 저장 <element는 포함. >
		for ( int i = 50 ; i > 0 ; i-=2) {
			treeSet.add(i) ; 
		}
		System.out.println(treeSet);
		...
		//12. NavigableSet<E> tialSet(E element) : element 값의 Tail 쪽으로 정렬해서 값을 저장 <element는 포함. >
		for ( int i = 50 ; i > 0 ; i-=2) {
			treeSet.add(i) ; 
		}
		System.out.println(treeSet);
