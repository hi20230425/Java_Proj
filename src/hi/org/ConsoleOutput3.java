...
public class ConsoleOutput3 {
	public static void main(String[] args) {
		...
		//실수형 자료형 : double 
		double weith = 70.5 ; 
		double weith2 = 50;      // 오류 발생이 안됨 : 정수 ==> 실수 자동 변환 
		...
		//1. println(); 으로 출력 : 문자열 과 변수를 + 연결해서 출력 
		...
		System.out.printf("나의 이름은 %s 이고, 나이는 %d 살이고, 몸무게는 %4.2f 입니다.", myName, age, weith);
