...
public class Object01 {
	// 클래스 내부 블락 : 1. 필드, 2.메소드(함수), 3. 생성자:클래스 이름과 동일한 메소드(리턴타입이 없는), 4.이너클래스  
	
	public Object01 () {}   // 생성자  : 필드의 값을 초기화 시에 사용됨 , 객체를 생성시 생성자를 호출함 
			//기본 생성자 : 생략될 수 있다. 
	...
	public static void main(String[] args) {
		...
		System.out.println("==========================================");
		// 클래스 는 객체화를 해야 사용 할 수 있다. 
		// 클래스는 "붕어빵틀", "프로그램"  <=====> 객체(인스턴스)는 메모리에 로드된 "붕어빵", "프로세스" 
		// 하나의 클래스를 가지고 여러개의 객체를 생성 할 수 있다. 
		
		//두번째 객체 생성 
		Object01 oc2 = new Object01();  
		//클래스명 (Type)  객체 (타입변수)  = 힙영역에 저장    생성자호출 () 기본생성자 호출 
