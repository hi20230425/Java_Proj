...
class Car{
	...
	//메소드 (기능) 
	public void stop () {
		System.out.println(carName + " 가 멈춤니다. ");
	}
	public void start() {
...
public class Object04 {
	public static void main(String[] args) {
			// c1 객체 : 현대자동차 / 그래져 / 검은색 / 250 / 1.0 톤
			// c2 객체 : 쌍용자동차 / 투싼 / 노란은색 / 300 / 2.0 톤
			// c3 객체 : 기아 / K9 / 흰색 / 350 / 2.5 톤
		...
		//객체 자체를 출력 할 경우 : 객체의 Heap 주소가 출력됨 : 패키지이름.클래스이름@주소   : 16진수 
		System.out.println(c1);
		
		System.out.println("== c1객체 출력 ==");
		c1.print();
		...
		System.out.println("== c2객체 ==");
		// c2 객체 생성 
		Car c2 = new Car(); 
		
		// 필드의 값을 입력  : c2 객체 : 쌍용자동차 / 투싼 / 노란은색 / 300 / 2.0 톤
		c2.company = "쌍용자동차"; 
		c2.carName = "투싼" ; 
		c2.carColor = "노란색";
		c2.carSpeed = 300; 
		...
		// 필드의 값 저장  : c3 객체 : 기아 / K9 / 흰색 / 350 / 2.5 톤
		c3.company = "기아자동차"; 
		c3.carName = "K9" ; 
		c3.carColor = "흰색";
		c3.carSpeed = 350; 
